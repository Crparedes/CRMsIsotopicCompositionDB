...
title <- tags$div(HTML(
  ...
  '<a id = "logo" href = "http://www.inm.gov.co" target = ”_blank” title = "MRCs Isotopic Composition DataBase" data-height="60">
  <img src = "IsotopeLogo.png" height = "90" alt = "LOGO" style = "margin-top: 5px">
  </a>', spcs(5),
  '</th>
  <th><h1 style="LINE-HEIGHT:5px; color: #dddddd; margin-bottom: 5px; font-size:30px;">
